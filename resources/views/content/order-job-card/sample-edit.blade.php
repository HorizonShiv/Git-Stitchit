                ...
                <div class="row">
                    <div class="col-3 col-lg-3">
                        ...
                        <input type="date" class="form-control date-picker" id="sampleDate" name="sampleDate"
                            placeholder="YYYY-MM-DD" value="{{ $JobOrders->date }}" />
                    </div>
                    <div class="col-3 col-lg-3">
                    ...
                    <div class="col-3 col-lg-3">
                        ...
                        <input required type="number" id="Rate" name="Rate" class="form-control" placeholder="Rate"
                            readonly />
                    </div>
                    ...
                    <div class="col-3 col-lg-3">
                        ...
                        <div class="input-group">
                            <input required type="number" value="{{ $JobOrders->qty }}" id="TotalQty" name="TotalQty"
