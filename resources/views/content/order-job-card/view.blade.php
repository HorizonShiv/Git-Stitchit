...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light float-left">Job Order/</span> View
    </h4>
                    ...
                    <div class="content">
						...
						<div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="JobCardNo" name="PlaningOrderNo"
                                    placeholder="Planing Order No" readonly value="{{ $JobOrders->job_order_no }}" />
                            </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="date" class="form-control date-picker" id="JobOrderDate" name="JobOrderDate"
                                    placeholder="YYYY-MM-DD" value="{{ $planingOrder->date ?? '' }}" readonly />
                            </div>
                            ...
                            <div class="col-md-2 mb-4">
                                ...
                                <input type="text" class="form-control" id="TotalQty" value="{{ $JobOrders->qty }}"
                                    name="Qty" readonly="" />
                            </div>
