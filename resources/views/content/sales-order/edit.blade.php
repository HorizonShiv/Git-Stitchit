                            ...
                            <div class="col-md-3">
                                ...
                                <select required id="CustomerName" name="CustomerName" class="select2 select21 form-select"
                                    ...
                                    @foreach (\App\Models\Customer::all() as $data)
                                        <option {{ $SalesOrders->customer_id == $data->id ? 'Selected' : '' }}
                            ...
                            <div class="col-md-3">
                                ...
                                <select required id="Brand" name="Brand" class="select2 select21 form-select"
                                    ...
                                    @foreach (\App\Models\Brand::all() as $data)
                                        <option {{ $SalesOrders->brand_id == $data->id ? 'Selected' : '' }}
                            ...
                            <div class="col-md-3">
                                ...
                                <select required id="Season" name="Season" class="select2 select21 form-select"
                                    ...
                                    @foreach (\App\Models\Season::all() as $data)
                                        <option {{ $SalesOrders->season_id == $data->id ? 'Selected' : '' }}
                                            value="{{ $data->id }}">{{ $data->name }} </option>
                                    @endforeach
                                </select>
                            </div>

                            <input type="hidden" value="{{ $SalesOrders->id }}" class="form-control date-picker"
                                id="SalesOrderId" name="SalesOrderId" value="" />
                                ...
                                <table class="datatables-basic table" id="datatable-list">
                                    ...
                                    <tbody id="styleInformation">
                                        @foreach ($SalesOrders->SalesOrderStyleInfo as $SalesOrderStyle)
                                            <tr id="saleRow_{{ $SalesOrderStyle->id }}">
                                                <td>{{ $SalesOrderStyle->StyleMaster->style_no ?? 'REMOVED' }}</td>
                                                <td>{{ $SalesOrderStyle->total_qty }}</td>
                                                <td>{{ $SalesOrderStyle->price }}</td>
                                                <td>{{ $SalesOrderStyle->price * $SalesOrderStyle->total_qty }}</td>
                                                <td>{{ $SalesOrderStyle->StyleMaster->StyleCategory->name ?? 'REMOVED' }}
                                                </td>
                                                <td><a type="button" href="#"
                                                        ...
                                                        style="margin-left: 10%"><span
                                                            class="ti ti-arrow-back-up"></span></a></td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                    </tbody>
        ...
        <div class="modal-dialog modal-xl modal-simple modal-edit-user modal-dialog-scrollable">
            <div class="modal-content p-3 p-md-5">
                <div class="modal-body">
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    <div class="text-center mb-4">
                        <h3 class="mb-2">Edit Parameter Information</h3>
                    </div>
                    <div class="row g-3">
                        <div class="col-md-12">
