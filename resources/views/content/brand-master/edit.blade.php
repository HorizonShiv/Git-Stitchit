...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light float-left">Master / Brand /</span> Edit
    </h4>
    <!-- Invoice List Widget -->
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="content">
                ...
                <form method="post" action="{{ route('brand-master-update', $Brand->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="col-md-12">
                                <label class="form-label" for="demographicName">Brand Name</label>
