                ...
                <tbody>
                    ...
                    @foreach (\App\Models\Brand::all() as $Brand)
                        <tr>
                            ...
                            <td>{{ $Brand->name }}</td>
                            <td>
                                <a class="btn btn-icon btn-label-primary mx-2" href="{{ route('brand-master-edit', $Brand->id) }}"><i
                                        class="ti ti-edit mx-2 ti-sm"></i></a>
                                <button type="button" class="btn btn-icon btn-label-danger mx-2" onclick="deleteBrand({{ $Brand->id }})"><i
