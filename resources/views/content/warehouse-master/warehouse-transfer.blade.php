...
@section('content')
    ...
    <form id="formid" class="source-item" action="{{ route('addwarehouseTransfer') }}" method="post"
                    ...
                    <div class="card-body">
                        <div class="users-list-filter">
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-4 col-lg-4">
                                    <label class="form-label" for="OrderId">From</label>
                                    <select required id="FromWarehouse" name="FromWarehouse"
                                ...
                                <div class="col-12 col-sm-4 col-lg-4">
                                    <label class="form-label" for="OrderId">To</label>
                                    <select required id="ToWarehouse" name="ToWarehouse"
                                        class="select2 select21 form-select" data-allow-clear="true"
                                        data-placeholder="Select Warehouse">
                                        <option value="" selected></option>
...
<script>
    ...
    function validateQty(id) {
        var avaiableQty = document.getElementById('avaiableQty_' + id).value;
        var qty = document.getElementById('qty_' + id).value;

        if (parseFloat(avaiableQty) < parseFloat(qty)) {
            toastr.error("You cannot add more then avaiable qty");
