...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Master / Item Category /</span> List
    </h4>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-icon btn-label-primary mx-2"
                                    href="{{ route('item-category-edit', $ItemCategory->id) }}"><i
                                        class="ti ti-edit mx-2 ti-sm"></i></a>
                                <button type="button" class="btn btn-icon btn-label-danger mx-2"
                                    onclick="deleteItemCategory({{ $ItemCategory->id }})"><i
    ...
    function deleteItemCategory(ItemCategoryId) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('item-category-delete') }}',
                    headers: {
