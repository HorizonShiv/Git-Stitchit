                    ...
                    <div class="card-body">
                        ...
                        <div class="content">
                            ...
                            <div class="form-check form-check-primary mt-3 mb-3">
                                <input class="form-check-input" style="height:25px;width:25px;" type="checkbox"
                                    name="CopyFromStyleCheck" onchange="toggleCopyStyleVisibility()" value="1"
                                    id="CopyFromStyleCheck">
                                <label class="form-check-label m-2 h5" for="customCheckPrimary"><strong>Copy From Other
                                        Style</strong></label>
                            </div>
                            ...
                            <div class="row g-4 mt-2">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select required id="Brand" name="Brand" class="select2 select21 form-select"
                                        ...
                                        @foreach (\App\Models\Brand::all() as $data)
                                            <option {{ old('Brand') == $data->id ? 'Selected' : '' }}
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select required id="Customer" name="Customer" class="select2 select21 form-select"
                                        ...
                                        @foreach (\App\Models\Customer::all() as $data)
                                            <option {{ old('Customer') == $data->id ? 'Selected' : '' }}
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select required id="Demographic" name="Demographic"
                                        ...
                                        @foreach (\App\Models\Demographic::all() as $data)
                                            <option {{ old('Demographic') == $data->id ? 'Selected' : '' }}
                                                value="{{ $data->id }}">{{ $data->name }} </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select required id="Fit" name="Fit" class="select2 select21 form-select"
                                        ...
                                        @foreach (\App\Models\Fit::all() as $data)
                                            <option {{ old('Fit') == $data->id ? 'Selected' : '' }}
                                                value="{{ $data->id }}">{{ $data->name }} </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select required id="Season" name="Season" class="select2 select21 form-select"
                                        ...
                                        @foreach (\App\Models\Season::all() as $data)
                                            <option {{ old('Season') == $data->id ? 'Selected' : '' }}
                                                value="{{ $data->id }}">{{ $data->name }} </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select id="Designer" name="Designer" class="select2 select21 form-select"
                                        ...
                                        @foreach (\App\Models\User::where('role', 'designer')->get() as $user)
                                            <option {{ old('Designer') == $user->id ? 'Selected' : '' }}
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select id="Merchant" name="Merchant" class="select2 select21 form-select"
                                        ...
                                        @foreach (\App\Models\User::where('role', 'merchant')->get() as $user)
                                            <option {{ old('Merchant') == $user->id ? 'Selected' : '' }}
                                                value="{{ $user->id }}">{{ $user->company_name }} -
                                                {{ $user->person_name }}</option>
                                        @endforeach
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control" value="{{ old('Color') }}" name="Color"
                                        placeholder="Color" id="Color" type="text">
                                </div>

                                <div class="col-md-3">
                                    <label class="form-label" for="rate">Rate</label>
                                    <input class="form-control" name="rate" value="{{ old('rate') }}"
                                        placeholder="Rate" id="rate" type="text">
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-5">
                                            <input class="form-control" name="SampleWeight" placeholder="Sample"
                                                id="SampleWeight" value="{{ old('SampleWeight') }}" type="number">
                                        </div>
                                        <div class="col-lg-1">:</div>
                                        <div class="col-lg-5">
                                            <input class="form-control" name="ProductionWeight" placeholder="Production"
                                                id="ProductionWeight" value="{{ old('ProductionWeight') }}"
                                                type="number">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <label class="form-label" for="sample_photo">Sample Photo</label>
                                    <input type="file" id="sample_photo" name="sample_photo[]" class="form-control"
                                        placeholder="Sample Photo" multiple />
                                </div>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-2" style="float: right">
                                        ...
                                        <input type="text" onkeyup="processCalculateValue(0)" id="processRate0"
                                            name="processData[0][processRate]" class="form-control" placeholder="Rate" />
                                    </div>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-2 col-lg-1">
                                        ...
                                        <input type="number" step="any" id="rawTotal0"
                                            name="bomListData[0][rawTotal]" class="form-control" placeholder="Total" />
                                    </div>
                                </div>
  ...
  `;
        ...
        function removeItem(dataId) {
            ...
            if (rowCount > 1) {
                ...
                toastr.error('You can not remove the first item..!!');
            }
        }
