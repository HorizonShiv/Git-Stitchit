...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Master / Style /</span> List
    </h4>
    ...
    <div class="card">
        <div class="card-body border-bottom d-none" id="filter-search">
            ...
            <div class="row">
                ...
                <div class="col-md-2 user_status"><label class="form-label" for="brand">Brand</label>
...
@section('vendor-script')
    ...
    <script>
        ...
        function getData(startDate = '', endDate = '') {
            ...
            if (brand.val() !== '') {
                $('#brandFilterShow').html('<b>Brand </b> : ' + brand.find('option:selected').text());
            } else {
   ...
   <script>
       function deleteStyleMaster(StyleMasterId) {
        Swal.fire({
            title: 'Are you sure?',
                ...
                $.ajax({
                    ...
                    success: function(resultData) {
                        if (resultData.success) {
                            ...
                            Swal.fire('Error',
                                'This Style has been used in the sales order, You cannot delete this !',
                                'error').then(() => {
                                $("#overlay").fadeOut(100);
                            });
                        }
