    ...
    <div class="card-body">
      <div class="content">
        ...
        <div class="content-header mb-4">
          <h3 class="mb-1">Demographic Information</h3>
        </div>
        <form method="post" action="{{ route('app-demographic-store') }}" enctype="multipart/form-data">
          @csrf
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="col-md-12">
                ...
                <input type="text" id="demographicName" name="demographicName" value=""
                       class="form-control" value="{{ old('demographicName') }}" placeholder="Demographic Name"/>
              </div>
            </div>
