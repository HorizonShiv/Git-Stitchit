                ...
                <div class="d-flex border rounded position-relative pe-0">
                  <div class="row w-100 p-3">
                    ...
                    <div class="col-md-3 col-12 mb-md-0 mb-3">
                      ...
                      <input type="number" class="form-control invoice-item-price mb-3" value="24" placeholder="24"
                             min="12"/>
                      <div>
                        <span>Discount:</span>
                    ...
                    <div class="col-md-2 col-12 mb-md-0 mb-3">
                      ...
                      <input type="number" class="form-control invoice-item-qty" value="1" placeholder="1" min="1"
                             max="50"/>
                    </div>
                  ...
                  <div class="d-flex flex-column align-items-center justify-content-between border-start p-2">
                    ...
                    <div class="dropdown">
                      <i class="ti ti-settings ti-xs cursor-pointer more-options-dropdown" role="button"
