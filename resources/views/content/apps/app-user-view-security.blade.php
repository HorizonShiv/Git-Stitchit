  ...
  <div class="row">
    ...
    <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
      ...
      <ul class="nav nav-pills flex-column flex-md-row mb-4">
        ...
        <li class="nav-item"><a class="nav-link active" href="javascript:void(0);"><i class="ti ti-lock me-1 ti-xs"></i>Security</a>
        </li>
        ...
        <div class="card-body">
          ...
          <div class="d-flex justify-content-between border-bottom mb-3 pb-2">
            ...
            <div class="action-icons">
              <a href="javascript:;" class="text-body me-1" data-bs-target="#enableOTP" data-bs-toggle="modal"><i
                  class="ti ti-edit ti-sm"></i></a>
              <a href="javascript:;" class="text-body"><i class="ti ti-trash ti-sm"></i></a>
            </div>
          </div>
          <p class="mb-0">Two-factor authentication adds an additional layer of security to your account by requiring
      ...
      <div class="card mb-4">
        ...
        <div class="table-responsive">
          <table class="table border-top">
            ...
            <tr>
              <td class="text-truncate"><i class='ti ti-brand-android text-success ti-xs me-2'></i> <span
            ...
            <tr>
              <td class="text-truncate"><i class='ti ti-brand-apple ti-xs me-2'></i> <span class="fw-medium">Chrome on MacOS</span>
              </td>
            ...
            <tr>
              <td class="text-truncate border-bottom-0"><i class='ti ti-brand-android text-success ti-xs me-2'></i>
