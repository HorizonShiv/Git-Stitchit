...
@section('content')
  ...
  <form class="source-item" action="{{ route('issue.issueToStore') }}" method="post"
            ...
            <div class="content">
              ...
              <div class="row g-3">
                ...
                <div class="col-md-2">
                  ...
                  <input type="date" class="form-control date-picker" id="JobOrderDate" name="JobOrderDate" readonly
                         value="{{ $JobOrders->date }}" />
                </div>
                ...
                <div class="col-md-2">
                  ...
                  <input type="text" class="form-control" value="{{ $JobOrders->rate }}" placeholder="Rate" readonly />
                </div>
        ...
        <div class="mt-2 card">
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="row card-body align-item-center">
                  <div class="form-check form-check-primary mt-3 col-md-6">
                    <input class="form-check-input" type="radio" name="issueType" id="departmentRadio" checked
                           onchange="checkIssueType()" value="department" />
              ...
              <div class="col-md-3" id="serviceDropDown">
                ...
                <select id="service_id" name="service_id" onchange="getVendorDetails();"
                  ...
                  @foreach ($serviceProviders as $serviceProvider)
                    <option value="{{ $serviceProvider->id }}">{{ $serviceProvider->company_name }}</option>
                  @endforeach
                </select>
              </div>
              <div class="col-md-2 mb-4">
                <label class="form-label" for="Cost Per Pisces">Value added Cost Per Piece</label>
                <input required="" type="text" value="0" id="cost" onkeyup="ValueAddedCostToTotal();" name="cost"
                       class="form-control"
                ...
                <div id="RawMaterialData">
                    ...
                    <div class="col-md-2" hidden>
                      ...
                      <input type="number" step="any" onkeyup="bomCalculateValue(0)"
                             ...
                             class="form-control" value="1" placeholder="Per Pc Qty" />
                    </div>
                    <div class="col-md-1">
                      <label class="form-label">Consume Qty</label>
                      <input type="number" step="any" onkeyup="bomCalculateValue(0)"
                             id="rawOrderQty0" name="bomListData[0][rawOrderQty]"
                             class="form-control" value="0" placeholder="Consume Qty" />
                    </div>
                    <div class="col-md-2" hidden>
                    ...
                    <div class="col-md-2">
                      ...
                      <input type="number" step="any" id="rawAvailableQty0"
                             name="bomListData[0][rawAvailableQty]" value="0" class="form-control"
                             placeholder="Qty" />
                    </div>
          ...
          <div class="mt-2 card">
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-lg-4 mt-4">
                  <input type="file" id="cad" name="cad" class="form-control" placeholder="">
                  @if (!empty($JobOrders->cad))
                    <p class="mt-2"><a target="_blank"
                                       href="{{ url('jobOrders/' . $JobOrders->id . '/' . $JobOrders->cad) }}">{{ $JobOrders->cad }}</a></p>
                  @endif
                </div>
                <div class="col-lg-4 mb-2">
                  <textarea class="form-control" id="cad_desc" name="cad_desc"
                            placeholder="CAD Instruction">{{ $JobOrders->cad_desc }}</textarea>
                </div>
              </div>
            </div>
          </div>
