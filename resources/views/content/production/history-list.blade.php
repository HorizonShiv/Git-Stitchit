...
@section('title', 'Production History List')
...
@section('content')
  ...
  <div class="card">
    ...
    <div class="card-datatable table-responsive">
      <table class="datatables-basic table" id="production-pending-list-history">
...
@section('vendor-script')
  ...
  <script>
    ...
    function getData(startDate = '', endDate = '') {
      ...
      if ($.fn.DataTable.isDataTable('#production-pending-list-history')) {
        $('#production-pending-list-history').DataTable().destroy();
      }

      var dtInvoiceTable = $('#production-pending-list-history');
      var company = $('#company');
