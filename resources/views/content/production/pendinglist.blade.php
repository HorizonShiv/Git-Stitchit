...
@section('content')
  ...
  <div class="card">
    ...
    <div class="card-datatable table-responsive">
      <table class="datatables-basic table" id="production-pending-list">
...
@section('vendor-script')
  ...
  <script>
    ...
    function getData(startDate = '', endDate = '') {
      ...
      if ($.fn.DataTable.isDataTable('#production-pending-list')) {
        $('#production-pending-list').DataTable().destroy();
      }

      var dtInvoiceTable = $('#production-pending-list');
      var company = $('#company');
