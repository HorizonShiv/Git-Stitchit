...
@section('title', 'Style-Category-Master')
...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Master / Style Category /</span> List
    </h4>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-icon btn-label-primary mx-2"
                                    href="{{ route('style-category-edit', $StyleCategory->id) }}"><i
                                        class="ti ti-edit mx-2 ti-sm"></i></a>
                                <button type="button" class="btn btn-icon btn-label-danger mx-2"
                                    onclick="deleteStyleCategory({{ $StyleCategory->id }})"><i
...
<script>
    function deleteStyleCategory(StyleCategoryId) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('style-category-delete') }}',
                    headers: {
