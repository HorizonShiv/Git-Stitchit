...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light float-left">Master / Style Category /</span> Edit
    </h4>
    <!-- Invoice List Widget -->
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="content">
                ...
                @foreach ($StyleCategorys as $StyleCategory)
                    <form method="post" action="{{ route('style-category-update', $StyleCategory->id) }}"
                            ...
                            <div class="col-md-6">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" id="categoryName" name="categoryName" class="form-control"
                                        value="{{ $StyleCategory->name }}" placeholder="Category Name" />
                                </div>
                            </div>
                        ...
                        <div class="row">
                            @foreach ($StyleCategory->StyleSubCategory as $subcategory)
                        ...
                        <div id="AddItemContainer" style="display:block;">
                            <div class="row" id="dynamicFormContainer">
                                <div class="col-md-6 mt-2">
                                    <div class="col-md-10">
                                        <label class="form-label" for="NewSubCategoryName_0">Subcategory Name</label>
                                        <input type="text" id="NewSubCategoryName_0" name="NewSubCategoryName[0]"
    ...
    function deleteSubCategory(SubCategory) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('style-subcategory-delete') }}',
                    headers: {
