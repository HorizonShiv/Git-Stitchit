...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light float-left">Master / Demographic /</span> Edit
    </h4>
    <!-- Invoice List Widget -->
        ...
        <div class="card-body">
            <div class="content">
                ...
                <div class="content-header mb-4">
                    <h3 class="mb-1">Demographic Edit</h3>
                </div>
                <form method="post" action="{{ route('demographic-update', $Demographic->id) }}"
                        ...
                        <div class="col-md-6">
                            <div class="col-md-12">
                                ...
                                <input type="text" id="demographicName" name="demographicName" class="form-control"
                                    value="{{ $Demographic->name }}" placeholder="Demographic Name" />
                            </div>
                        </div>
                    </div>
                    <br>
