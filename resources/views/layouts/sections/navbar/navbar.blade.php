              ...
              <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                  <div class="avatar avatar-online">
                    <img
                      src="{{ !empty(Auth::user()->profile_photo_url) ? Auth::user()->profile_photo_url : asset('assets/img/avatars/1.png') }}"
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                  ...
                  <li>
                    <a class="dropdown-item"
                       href="{{ route('app-user-view',base64_encode(Auth::user()->id)) }}">
                  ...
                  <span class="d-flex align-items-center align-middle">
                    ...
                    <span
                      class="flex-shrink-0 badge badge-center rounded-pill bg-label-success w-px-20 h-px-20">{{ \App\Models\Invoice::count() }}</span>
                  </span> </a>
                  </li>
                  <li>
                    <div class="dropdown-divider"></div>
